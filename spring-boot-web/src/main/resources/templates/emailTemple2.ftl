...
<a style="color: rgb(236, 127, 232); text-decoration: none;" target="_blank">星云科技通知邮件</a></span></td></tr></tbody>    
...
<span style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #000000; line-height: 230%;">
        <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #000000; line-height: 130%;margin:10px; padding:0 0 0 20px;font-weight:bold;">尊敬的用户  <span style="color:red;display: inline-block;font-family: Microsoft YaHei, Helvetica, sans-serif;font-size: 22px;">${username}</span>   :</p>
		
		<p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #000000; line-height: 130%;margin:10px;padding:0 0 0 40px;font-weight:bold;">您好！</p>
		
		<p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; color: #000000; line-height: 130%;margin:10px;padding:0 0 0 60px;">${content}</p>
</span>
<br>
